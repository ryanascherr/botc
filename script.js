let characters = [
    ...
    {
        name: "Exorcist",
        intro: "<p>The Exorcist prevents the Demon from waking to attack.<p><ul><li>Each night, the Exorcist chooses a player. If they choose a player who is not the Demon, the Demon may still attack. If they choose the Demon, the Demon does not wake tonight, so does not choose players to attack tonight. The Demon learns that they cannot attack and who the Exorcist is.</li><li>Any other Demon abilities still function—such as the Zombuul staying alive if killed, the Pukka killing a player they attacked on a previous night, or the Shabaloth regurgitating a player.</li><li>The Exorcist may not choose the same player two nights in a row.</li></ul>",
